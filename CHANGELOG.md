...
### Changed
- **BREAKING CHANGE**: `pkg/discovery.ReverseDNS` now requires `context.Context` as first parameter.
- **BREAKING CHANGE**: `pkg/discovery.GetMAC` now requires `context.Context` as first parameter.
- **BREAKING CHANGE**: `pkg/scan.ReverseDNS` now requires `context.Context` as first parameter.
- **BREAKING CHANGE**: `pkg/scan.GetMAC` now requires `context.Context` as first parameter.
